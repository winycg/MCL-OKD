...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=12, number_net=4, block_config=(16, 16, 16), num_branches=3, bpscale=False, avg=False,
        ...
        self.gate_fc = nn.Linear(60, self.number_net)
...
def one_densenetd40k12(pretrained=False, path=None, **kwargs):
    """
...
if __name__ == '__main__':
    net = one_densenetd40k12(num_classes=100)
