...
class HCGNet(nn.Module):
    def __init__(self, growth_rate=(8, 16, 32), block_config=(6,12,24,16), number_net=4,
        ...
        self.gate_fc = nn.Linear(attention_input_dimension, self.num_branches)
        self.gate_norm = nn.BatchNorm1d(self.num_branches)
