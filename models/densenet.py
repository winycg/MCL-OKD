...
class DenseNet(nn.Module):
    def __init__(self, growth_rate=12, block_config=(16, 16, 16), num_branches=3, bpscale=False, avg=False,
                 compression=0.5,
        ...
        self.features.add_module('norm_final_', nn.BatchNorm2d(num_features))
        self.features.add_module('relu_final_', nn.ReLU(inplace=True))
...
def densenetd40k12(**kwargs):
    model = DenseNet(growth_rate=12, block_config=[6, 6, 6], **kwargs)
    return model


if __name__ == '__main__':
    net = densenetd40k12(num_classes=100)
