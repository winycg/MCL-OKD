...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, number_net=4, zero_init_residual=False,
...
def mcl_okd_resnet18(**kwargs):
    return _resnet(BasicBlock, [2, 2, 2, 2], **kwargs)


def mcl_okd_resnet34(**kwargs):
    return _resnet(BasicBlock, [3, 4, 6, 3], **kwargs)


if __name__ == '__main__':
    net = mcl_okd_resnet34(num_classes=1000)
