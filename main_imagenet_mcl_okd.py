...
parser.add_argument('--arch', default='mcl_okd_resnet34', type=str, help='network architecture')
...
# dataset
num_classes = 1000
trainloader, testloader, n_data, n_label = get_dataloader_sample(train_data_folder=os.path.join(args.data, 'train'),
                                                        test_data_folder=os.path.join(args.data, 'val'),
...
def train(epoch, criterion_list, optimizer):
    ...
    for batch_idx, (input, target, index, contrast_idx) in enumerate(trainloader):
        ...
        print('Batch:{}, Time:{:.3f}'.format(batch_idx,
